...
- **整体架构设计**
  ...
  ![image-20200612215327156](pics\image-20200612215327156.png)
...
- **优化方案**
  ...
  - **页面静态化、页面缓存**
    ...
    ​		![image-20200613121321101](pics\image-20200613121321101.png)
...
![image-20200613174719022](pics\image-20200613174719022.png)

&nbsp;&nbsp; &nbsp;&nbsp; 顶级目录包括java和resources两个目录，其中java目录是项目源码目录，resources目录是资源目录，包括配置文件、页面、静态资源（如商品图片）等。

- **com.shop**

![image-20200613180133262](pics\image-20200613180133262.png)
...
![image-20200616110302469](pics\image-20200616110302469.png)
...
![image-20200616082836217](pics\image-20200616082836217.png)
...
- **消息封装**
  ...
  ​	![image-20200614094429982](pics\image-20200614094429982.png)
