...
- **整体架构设计**
  ...
  ![image-20200612215327156](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200612215327156.png)
...
- **优化方案**
  ...
  - **页面静态化、页面缓存**
    ...
    ​		![image-20200613121321101](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200613121321101.png)
...
![image-20200613174719022](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200613174719022.png)

​		顶级目录包括java和resources两个目录，其中java目录是项目源码目录，resources目录是资源目录，包括配置文件、页面、静态资源（如商品图片）等。

- **com.shop**

![image-20200613180133262](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200613180133262.png)
...
![image-20200616110302469](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200616110302469.png)
...
![image-20200616082836217](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200616082836217.png)
...
- **消息封装**
  ...
  ​	![image-20200614094429982](C:\Users\lyw\AppData\Roaming\Typora\typora-user-images\image-20200614094429982.png)
...
​		我觉得有句话说的很好：技术是拿来解决问题的，而不是拿来秀的。我们学习技术时务必先了解技术的原理、使用场景、为什么要用、可以解决哪些问题等，而不是一股脑地把各种技术往项目中堆积，就比如一个公司内部使用的ERP系统，如果采用秒杀系统的架构，纯属浪费资源。
